...
const CRACKS = `url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M10 10 L20 30 L15 50 L30 70 M60 10 L50 40 L70 60 L65 90 M90 20 L80 50 L85 80' stroke='rgba(0,0,0,0.4)' fill='none' stroke-width='0.5'/%3E%3C/svg%3E")`;
...
export default {
    ...
    effects: {
        ...
        depth: {
            ...
            // Legacy/Base Compat
            engraved: 'inset 2px 2px 8px rgba(0,0,0,0.85), inset -1px -1px 2px rgba(255,255,255,0.08)',
            floating: '0 15px 35px rgba(0,0,0,0.8), 0 0 0 1px rgba(48, 213, 200, 0.1)',
        },
