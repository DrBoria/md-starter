...
const BreadcrumbLink = styled(Link)`
  color: ${({ theme }) => theme.colors.sectionContent}; // Default link color from theme
  text-decoration: none;

  &:hover {
    color: ${({ theme }) => theme.colors.highlighted}; // Hover color from theme
  }
`;

// Styled component for active breadcrumb item
const ActiveBreadcrumb = styled.div`
  color: ${({ theme }) => theme.colors.sectionContent}; // Text color for active item
  font-weight: 500; // Medium font weight
  padding: ${({ theme }) => theme.variables.offsets.elementContent.mobile + "px"}; // Padding from theme
  background-color: ${({ theme }) => theme.colors.overlay}; // Background color from theme
...
const ChevronIcon = styled(LucideIcon)`
  ...
  color: ${({ theme }) => theme.colors.disabled}; // Icon color from theme
`;
...
const HomeIcon = styled(LucideIcon)`
  ...
  color: ${({ theme }) => theme.colors.sectionContent}; // Icon color from theme
`;
