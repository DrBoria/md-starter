...
return (
  <div>
    {/* Basic Examples */}
    <ActionsMenuButton onDuplicate={() => {}} onEdit={() => {}}>ActionsMenuButton</ActionsMenuButton>
    <ActionsMenuButton onDuplicate={() => {}} onEdit={() => {}} disabled>Disabled Menu</ActionsMenuButton>
    <ActionsMenuButton onDuplicate={() => {}} onEdit={() => {}} size="sm">Small Menu</ActionsMenuButton>
    {/* Different Sizes */}
    <ActionsMenuButton onDuplicate={() => {}} onEdit={() => {}} size="large">Large Menu</ActionsMenuButton>
    <ActionsMenuButton onDuplicate={() => {}} onEdit={() => {}} size="xl">Extra Large Menu</ActionsMenuButton>
    {/* With Loading State */}
    <ActionsMenuButton onDuplicate={() => {}} onEdit={() => {}} isLoading>Loading Menu</ActionsMenuButton>
    {/* With Custom Icon */}
    <ActionsMenuButton onDuplicate={() => {}} onEdit={() => {}} icon="Menu">Custom Icon</ActionsMenuButton>
    {/* Basic Examples */}
    ...
    <ButtonLink href={"/settings"} icon="Settings" text="Settings" />
    <ButtonLink href={"/delete"} icon="Trash" text="Delete" tone="danger" />
    {/* Different Tones */}
