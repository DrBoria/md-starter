...
import type { ToastsContextType as LoggerContextType, TToastData } from '@md/components/default/feedback';
import { ToastsContext as LoggerContext, useToasts as useLogger } from '@md/components/default/feedback';
export { useLogger };
