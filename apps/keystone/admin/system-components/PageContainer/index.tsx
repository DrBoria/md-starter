...
const PageWrapper = styled.div`
  ...
  grid-template-rows: repeat(2, ${({ theme }: { theme: TTheme }) => theme.elements.header.height}) auto;
  height: 100vh;
  isolation: isolate;
  ...
  @media (min-width: 576px) {
    ...
    grid-template-rows: ${({ theme }: { theme: TTheme }) => theme.elements.header.height} auto;
  }
`;
...
const Content = styled.main`
  ...
  min-width: 0;
  padding-left: ${({ theme }: { theme: TTheme }) => theme.offsets.elementContent};
  padding-right: ${({ theme }: { theme: TTheme }) => theme.offsets.elementContent};
  position: relative;
